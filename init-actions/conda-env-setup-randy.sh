...
# ToDo: install from conda package instead
gsutil cp gs://rapidsai-test-1/binaries/xgboost-0.83.dev0-py3-none-any.whl xgboost-0.83.dev0-py3-none-any.whl
pip install xgboost-0.83.dev0-py3-none-any.whl
